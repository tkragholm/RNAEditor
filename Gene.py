...
class Gene(object):
    ...
    __slots__ = ["geneId", "geneType", "chromosome", "start", "end", "strand", "names", "exons", "codingExons",
                 "transcripts"]
    ...
    def __str__(self, *args, **kwargs):
        return "\n".join(
            [self.geneId, str(self.names), "%s:%s-%s" % (str(self.chromosome), str(self.start), str(self.end))])
    ...
    def printInfo(self):
        ...
        str(self.chromosome), str(self.start), str(self.end), "+" if self.strand else "-"))
